          ...
          <form className="space-y-10" onSubmit={handleSubmit}>
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-transparent border-b border-gray-300 py-3 text-lg outline-none focus:border-black transition-all peer"
                placeholder=" "
              />
              <label className={`absolute left-0 text-gray-400 pointer-events-none transition-all duration-300
                ${formData.name
                  ? '-top-3 text-xs text-black'
                  : 'top-3 peer-focus:-top-3 peer-focus:text-xs peer-focus:text-black'}`}
              >
                Name
              </label>
            </div>
            ...
            <div className="relative pt-4">
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="w-full bg-transparent border-b border-gray-300 py-3 text-lg outline-none focus:border-black transition-all resize-none peer"
                placeholder=" "
              ></textarea>
              <label className={`absolute left-0 text-gray-400 pointer-events-none transition-all duration-300
                ${formData.message
                  ? 'top-0 text-xs text-black'
                  : 'top-7 peer-focus:top-0 peer-focus:text-xs peer-focus:text-black'}`}
              >
